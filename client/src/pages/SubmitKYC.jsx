    ...
    <div className="min-h-screen bg-slate-50 py-12 px-4">
      <div className="max-w-2xl mx-auto bg-white rounded-3xl shadow-xl border border-slate-100 overflow-hidden">
        <div className="bg-slate-900 p-8 text-white text-center">
          <h1 className="text-3xl font-black mb-2 uppercase tracking-tighter">Identity Verification</h1>
          <p className="text-slate-400">Complete your KYC to unlock full LandSolutions features.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
          ...
          {success && (
            <div className="p-4 bg-green-50 text-green-700 rounded-2xl flex items-center gap-3 border border-green-100">
              ...
              <p className="font-bold text-sm">Documents received! Redirecting to dashboard...</p>
            </div>
          )}
          ...
          >
            {loading ? "Uploading Securely..." : "Submit Verification Docs"}
          </button>
        </form>
      </div>
